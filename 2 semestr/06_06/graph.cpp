...
Graph::vertex_iter Graph::vertex_by_index(int index)
{
    vertex_iter iter(this, index);
    return iter;
}

Graph::edge_iter Graph::edge_by_index(int x, int y)
{
    edge_iter iter(this, x, y);
    return iter;
}
...
int Graph::edge_iter::show_x()
{
    return current_x;
}

int Graph::edge_iter::show_y()
{
    return current_y;
}
